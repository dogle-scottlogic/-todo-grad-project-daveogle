...
var TodoService = (function () {
    ...
    TodoService.prototype.setTodo = function (todo) {
        return this.http
            .post(this.todosUrl, JSON.stringify(todo), { headers: new http_1.Headers({ "Content-Type": "application/json" }) })
            .toPromise()
    ...
    TodoService.prototype.removeTodo = function (id) {
        ...
        return this.http.delete(deleteUrl, { body: "", headers: new http_1.Headers({ "Content-Type": "application/json" }) })
            .toPromise()
            .catch(this.handleError);
    };
    ...
    TodoService.prototype.updateTodo = function (todo) {
        ...
        return this.http
            .put(putUrl, JSON.stringify(todo), { headers: new http_1.Headers({ "Content-Type": "application/json" }) })
            .toPromise()
            .then(function (res) { return res; })
            .catch(this.handleError);
    };
